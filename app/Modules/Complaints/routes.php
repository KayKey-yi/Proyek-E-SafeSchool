...
Route::controller(ComplaintsController::class)->middleware(['web','auth:pengguna'])->name('complaints.')->group(function(){
...
Route::controller(ComplaintsController::class)->middleware(['web','auth:web'])->name('complaints.')->group(function(){
