    ...
    <section class="section">
        <div class="card kt-form-card">
            ...
            <div class="card-body">
                ...
                <form class="form form-horizontal" action="{{ route('item_reports.update', $item_reports->id) }}" method="POST">
                    <div class="form-body">
                        @csrf @method('patch')
                        ...
                        <div class="offset-md-3 ps-2 pt-2 d-flex gap-2">
                            ...
                            <a href="{{ route('item_reports.index') }}" class="btn btn-outline-secondary">Batal</a>
                        </div>
                  </div>
                </form>
            </div>
