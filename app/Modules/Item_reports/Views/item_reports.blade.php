            ...
            <div class="card-body">
                <div class="row align-items-center mb-3 g-2">
                    <div class="col-12 col-md-9">
                        <form action="{{ route('item_reports.index') }}" method="get">
                    ...
                    <div class="col-12 col-md-3 text-md-end">
						{!! button('item_reports.create', $title) !!}
                    </div>
                </div>
                        ...
                        <tbody>
                            ...
                            @forelse ($data as $item)
                                <tr>
                                    ...
                                    <td>
										{!! button('item_reports.show','', $item->id) !!}
										{!! button('item_reports.edit', $title, $item->id) !!}
                                        {!! button('item_reports.destroy', $title, $item->id) !!}
                                    </td>
                                </tr>
                            @empty
                                <tr>
