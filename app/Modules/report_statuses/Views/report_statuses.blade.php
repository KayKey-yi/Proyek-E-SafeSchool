            ...
            <div class="card-body">
                <div class="row align-items-center mb-3 g-2">
                    <div class="col-12 col-md-9">
                        <form action="{{ route('report_statuses.index') }}" method="get">
                    ...
                    <div class="col-12 col-md-3 text-md-end">
						{!! button('report_statuses.create', $title) !!}
                    </div>
                </div>
                        ...
                        <tbody>
                            ...
                            @forelse ($data as $item)
                                <tr>
                                    ...
                                    <td>
										{!! button('report_statuses.show','', $item->id) !!}
										{!! button('report_statuses.edit', $title, $item->id) !!}
                                        {!! button('report_statuses.destroy', $title, $item->id) !!}
                                    </td>
                                </tr>
                            @empty
                                <tr>
